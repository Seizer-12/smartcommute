		...
		<div className={`w-full ${className}`}>
			...
			<div className="relative flex items-center group">
				...
				<input
					...
					} rounded-xl py-3 sm:py-3.5 pl-11 ${isPassword ? "pr-12" : "pr-4"} text-sm text-slate-900 placeholder-slate-400 outline-none transition-all shadow-sm`}
				/>
				{isPassword && (
					<button
						type="button"
						...
						className="absolute right-3 rounded p-1.5 text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
					>
